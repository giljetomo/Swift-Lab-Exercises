...
func createUser() -> User? {
    guard let fName = firstNameTextField.text, let lName = lastNameTextField.text, let age = ageTextField.text //, !age.isEmpty
    else { return nil }
