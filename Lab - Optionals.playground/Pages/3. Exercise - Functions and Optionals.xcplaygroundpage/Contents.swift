...
func checkAge(_ age: String) {
    let a = Int(age)
    if let unwrappedAge = a {
        unwrappedAge > 18 ? print("Welcome! \(unwrappedAge)") : print("Not old enough")
    } else {
        print("Wrong")
    }
}
...
func getItem (_ name: String) -> Double? {
...
//if let price = getItem("Donuts") {
//    print(price)
//}
if let price = getItem("m") {
    print(price)
} else {
    print("Out of stock")
}
