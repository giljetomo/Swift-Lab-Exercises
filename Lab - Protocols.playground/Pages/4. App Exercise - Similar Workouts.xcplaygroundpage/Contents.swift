...
let a = RunningWorkout(distance: 1.0, time: 1.0)
let b = SwimmingWorkout(distance: 2.0, time: 2.0)

simpleWorkoutDescription(workout: a)
simpleWorkoutDescription(workout: b)
